        ...
        <div class="lg:w-1/2 px-5 xl:pl-12 pt-10">
          ...
          <div class="max-w-[450px] m-auto pt-24 pb-16">
            ...
            <form method="POST" action="{{ route('login') }}">
              ...
              <div class="mb-4">
                  <input
                      ...
                      name="email"
                      id="email"
                      class="text-bgray-800 text-base border border-bgray-300 dark:border-darkblack-400 dark:bg-darkblack-500 dark:text-white h-14 w-full focus:border-success-300 focus:ring-0 rounded-lg px-4 py-3.5 placeholder:text-bgray-500 placeholder:text-base @error('email') is-invalid @enderror"
              ...
              <div class="mb-6 relative">
                  <input
                      ...
                      name="password"
                      id="password"
                      class="text-bgray-800 text-base border border-bgray-300 dark:border-darkblack-400 dark:bg-darkblack-500 dark:text-white h-14 w-full focus:border-success-300 focus:ring-0 rounded-lg px-4 py-3.5 placeholder:text-bgray-500 placeholder:text-base @error('password') is-invalid @enderror"
              ...
              <div class="flex justify-between mb-7">
                  ...
                  <div>
                      <a href="{{ route('password.request') }}" class="modal-open text-success-300 font-semibold text-base underline">Forgot Password?</a>
                  </div>
              </div>
            ...
            <p class="text-bgray-600 dark:text-white text-center text-sm mt-6">
              @ 2023 Samoedra. All Right Reserved.
            </p>
          </div>
        </div>
        <!-- Right -->
